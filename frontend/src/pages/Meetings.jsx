    ...
    <div className="space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {team.length > 0 && (
            <div>
              ...
              <div
                className="flex flex-wrap gap-1.5 max-h-32 overflow-auto p-1"
                role="group"
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          description={
            canCreate
              ? 'Click "Schedule meeting" to create your first one and invite attendees.'
              : 'New meetings will appear here once your team schedules them.'
          }
        />
      ) : (
        <>
      ...
      <ConfirmDialog
        ...
        message={
          confirmDelete ? `Permanently delete "${confirmDelete.title}"?` : ''
        }
        confirmLabel="Delete"
        danger
      ...
      <CardBody>
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-3 min-w-0">
            <div className="shrink-0 w-10 h-10 rounded-md bg-gradient-to-br from-brand-500 to-violet-600 text-white flex items-center justify-center text-lg">
              📹
            </div>
          ...
          {canDelete && (
            <button
              onClick={onDelete}
              className="text-fg-muted hover:text-danger-600 transition-colors p-1"
              title="Delete"
