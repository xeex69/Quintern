    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-fg-muted mt-1">
          Immutable history of performance scores on a 1-10 scale.
        </p>
      </div>
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          description={
            canRate
              ? 'Rate your team on a 1–10 scale. Every rating is immutable and audit-logged.'
              : 'Ratings submitted to you will show up here.'
          }
              ...
              <CardBody>
                <div className="flex items-center justify-between gap-2 flex-wrap">
                  <div className="flex items-center gap-2">
                    ...
                    {r.category && (
                      <span className="text-[10px] font-semibold uppercase tracking-wider text-fg-muted bg-surface-sunken rounded px-1.5 py-0.5">
                        {r.category}
                      </span>
                    )}
                  </div>
